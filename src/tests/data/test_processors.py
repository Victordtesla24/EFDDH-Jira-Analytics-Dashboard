...
from src.data.processors import JiraDataProcessor, process_jira_data, process_sprint_data
...
def test_get_sprint_metrics_with_data(processed_jira_data):
    ...
    assert metrics["completion_rate"] == pytest.approx(66.67, rel=0.01)  # 2 out of 3 resolved
